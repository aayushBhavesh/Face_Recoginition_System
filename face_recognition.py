...
class Face_R:
    def __init__(self, root):
        ...
        img_top = Image.open(r"C:\Users\bhave\OneDrive\Desktop\Face recognition system\college_images\face_detector1.jpg")
        ...
        img_bottom = Image.open(r"C:\Users\bhave\OneDrive\Desktop\Face recognition system\college_images\facial_recognition_system_identification_digital_id_security_scanning_thinkstock_858236252_3x3-100740902-large.jpg")
        ...
        b1_1=Button(lbl_img_bottom,text="Face Recognition",command=self.f_recognition,cursor="hand2",font=("times new roman",18,"bold"),bg="red",fg="white")
    ...
    def f_recognition(self):
       ...
       clf.read(r"C:\Users\bhave\OneDrive\Desktop\Face recognition system\classifier.xml")

       videocap=cv2.cv2.VideoCapture(0)
       while True:
