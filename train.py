...
class Train:
    def __init__(self, root):
        ...
        img_top = Image.open(r"C:\Users\bhave\OneDrive\Desktop\Face recognition system\college_images\facialrecognition.png")
        img_top = img_top.resize((1530, 325), Image.Resampling.LANCZOS)
        self.photoimg_top = ImageTk.PhotoImage(img_top)
        lbl_img_top = Label(self.root, image=self.photoimg_top)
        lbl_img_top.place(x=0, y=55, width=1530, height=325)
        ...
        img_bottom = Image.open(r"C:\Users\bhave\OneDrive\Desktop\Face recognition system\college_images\photos.jpg")
        ...
        lbl_img_bottom.place(x=0, y=440, width=1530, height=325)
